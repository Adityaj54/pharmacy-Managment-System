...
<nav>
<ul>
			<li><a href="cashier.php"><button class="button button3">Dashboard</button></a></li>
			<li><a href="payment.php"target="_top"><button class="button button3">Process Payment</button></a></li>
...
<article>
            	<a href="cashier.php" class="dashboard-module">
			     ...
			     <a href="payment.php"target="_top" class="dashboard-module">
                	...
                	<span><button class="button button1">Process Payments</button></span>
                </a>
              </div>
</article>
