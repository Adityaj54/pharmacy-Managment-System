...
<ul>
  <button class="button button2" onclick="openCity(event, 'content_1')">View Stock</button>
  <button class="button button2" onclick="openCity(event, 'content_2')">Add medicine</button>
  </ul>
