...
<li><a href="logout.php"><button class="button button3">Logout</button></a></li>
  ...
  <nav>
		...
		<ul>
<li><a href="pharmacist.php"><button class="button button1">Dashboard</button></a></li>
			<li><a href="prescription.php"><button class="button button1">Prescription</button></a></li>
			<li><a href="stock_pharmacist.php"><button class="button button1">Stock</button></a></li>
...
<ul>
  <button class="button button2" onclick="openCity(event, 'content_1')">View </button>
  <button class="button button2" onclick="openCity(event, 'content_2')">Create New</button>
  </ul>
...
?> 
		...
		<form name="myform"  action="123.php" method="post" >
			<table width="200" height="106" border="0" >	
				<tr><td align="left"><input name="custId" placeholder="Customer ID" id="custId"type="text" style="width:170px" required="required" /></td></tr>
				<tr><td align="left"><input name="custName" placeholder="Customer Name" id="custName"type="text" style="width:170px" required="required" /></td></tr>
